...
public class CallHierachyGenerator extends JavaRecursiveElementVisitor implements IGenerator {
    private static final Logger LOGGER = Logger.getInstance(CallHierachyGenerator.class);
    ...
    public CallHierachyGenerator(SequenceParams params) {
        this.params = params;
        SHOW_LAMBDA_CALL = SequenceSettingsState.getInstance().SHOW_LAMBDA_CALL;
    }

    public CallHierachyGenerator(SequenceParams params, int offset) {
        this(params);
